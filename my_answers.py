...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #hidden_error = self.weights_hidden_to_output @ output_error_term  # Así te da (2,)
        hidden_error = np.dot(self.weights_hidden_to_output, output_error_term)  # Así te da (2,)
